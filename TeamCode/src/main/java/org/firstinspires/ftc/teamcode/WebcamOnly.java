...
@Autonomous(name = "WebcamOnly")
public class WebcamOnly extends LinearOpMode {
    OpenCvWebcam webcam;
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
               ...
               //ps: not here for now
                ...
                sleep(500);
                _4barServo.setPosition(0.5);
                encoder_drive(-255,-255,-255,-255,0.3,0.3,0.3,0.3);
                Encoder_SlideRaise(2600, -2600, 0.7, 0.7);
               encoder_drive(439,-439,-439,439,0.3,0.3,0.3,0.3);
                Encoder_SlideRaise(-300,300,0.7,0.7);
               encoder_drive(-910,-910,-910,-910,0.3,0.3,0.3,0.3);
              sleep(400);
              intakeServo.setPower(0.8);
              ...
              encoder_drive(200,200,200,200,0.3,0.3,0.3,0.3);
                encoder_drive(480,-480,-480,480,0.3,0.3,0.3,0.3);
                encoder_drive(150,150,150,150,0.3,0.3,0.3,0.3);
                sleep(250);
                _4barServo.setPosition(0.8);
                sleep(300);
                intakeServo.setPower(-0.8);
